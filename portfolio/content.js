...
const CONTENT = {
  ru: {
    ...
    alts: {
      ...
      watercolorStillLife: { title: "Этюд \"Луковый\"", specs: "акварель · 14,8 × 21 см" },
  ...
  en: {
    ...
    alts: {
      ...
      watercolorStillLife: { title: "Study \"Onion\"", specs: "watercolor · 14.8 × 21 cm" },
  ...
  sr: {
    ...
    alts: {
      ...
      watercolorStillLife: { title: "Studija \"Crni luk\"", specs: "akvarel · 14,8 × 21 cm" },
